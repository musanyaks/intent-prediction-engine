...
[![Live Demo](https://img.shields.io/badge/Live_Demo-HuggingFace_Spaces-blue)](https://huggingface.co/spaces/yourname/intent-prediction-demo)
...
|--------|------|-------------|
| `intent_class` | browse / compare / ready-to-buy / at-risk | Route to different UX flows |
| `purchase_prob` | Probability [0,1] | Trigger urgency mechanisms |
| `ltv_30d` | Continuous ($) | Decide discount depth |
| `churn_7d` | Probability [0,1] | Trigger retention offers |
...
curl -X POST http://localhost:8000/predict \
  ...
  -d '{
    ...
    "events": [
      {"event_type": "page_view", "timestamp": "2026-08-01T10:00:00Z", "product_id": null},
      {"event_type": "search", "timestamp": "2026-08-01T10:00:15Z", "product_id": null},
      {"event_type": "cart_add", "timestamp": "2026-08-01T10:02:00Z", "product_id": "prod_laptop_001"}
    ],
    "user_history_orders": 3,
    "user_avg_order_value": 450.0,
    "device_type": "mobile"
  }'
```
...
```json
{
  ...
  "ltv_30d_estimate": 350.0,
  "churn_7d_probability": 0.02,
  "recommended_action": "show_urgency_messaging",
